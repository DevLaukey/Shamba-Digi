...
router.get("/dashboard/addvision", isValidUser, async function (req, res, next) {
 User.findOne({ _id: req.user._id })
   .then((result) => {
     return res.render("dashboard/addvision", { "user": result });
   })
   .catch((err) => {
...
router.post("dashboard/addvision", isValidUser, async function (req, res, next) {
