...
// router.get("/items/additems", isValidUser, async function (req, res, next) {
//   User.findOne({ _id: req.user._id })
//     .then((result) => {
//       return res.render("dashboard", { user: result });
//     })
...
// router.post("items/additems", isValidUser, async function (req, res, next) {
...
router.get("/settings", isValidUser, function (req, res, next) {
  Board.findOne({ _id: req.user._id })
    .then((result) => {
